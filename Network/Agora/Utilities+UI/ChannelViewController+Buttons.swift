...
extension ChannelViewController {
    ...
    func getHostButton() -> UIButton {
        if let h/Users/sumitbhardwaj/Desktop/Eithes Before Backup/Eithes/Network/Agora/Utilities+UI/ChannelViewController+Permissions.swiftostButton = self.hostButton {
            return hostButton
        }
